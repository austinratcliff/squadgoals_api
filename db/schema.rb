...
ActiveRecord::Schema.define(version: 2019_06_28_203300) do
  ...
  create_table "collaboration_goals", force: :cascade do |t|
  ...
  create_table "project_sub_goals", force: :cascade do |t|
